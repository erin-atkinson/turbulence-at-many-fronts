...
#SBATCH --time=4:00:00
#SBATCH --job-name=0_06-0_2-0_05-0_0-C
#SBATCH --output=../scratch/logs/0_06-0_2-0_05-0_0-C.txt
...
output_folder=$SCRATCH/turbulence-at-many-fronts/0_06-0_2-0_05-0_0-C
