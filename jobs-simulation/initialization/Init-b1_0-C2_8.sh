...
output_folder=$SCRATCH/turbulence-at-many-fronts/Init-b1_0-C2_8
...
# Copy to a t > 0 run
mkdir $output_folder/../a0_10-b1_0-C2_8
cp $output_folder/checkpoint_* $output_folder/../a0_10-b1_0-C2_8
