...
#SBATCH --time=3:00:00
#SBATCH --job-name=wind-test-init
#SBATCH --output=../scratch/logs/wind-test-init.txt
...
output_folder=$SCRATCH/turbulence-at-many-fronts/wind-test-init
...
comment="Initialised front with wind"
