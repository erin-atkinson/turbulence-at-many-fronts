...
#SBATCH --time=4:00:00
#SBATCH --job-name=resolution-test-x1400-z96
#SBATCH --output=../scratch/logs/resolution-test-x1400-z96.txt
...
output_folder=$SCRATCH/turbulence-at-many-fronts/resolution-test-x1400-z96
...
comment="Resolution test x1400 z96"
