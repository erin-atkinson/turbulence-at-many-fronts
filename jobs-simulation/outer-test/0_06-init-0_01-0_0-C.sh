...
#SBATCH --time=4:00:00
#SBATCH --job-name=0_06-init-0_01-0_0-C
#SBATCH --output=../scratch/logs/0_06-init-0_01-0_0-C.txt
...
mkdir $output_folder/../0_06-0_2-0_01-0_0-C
cp $output_folder/checkpoint* $output_folder/../0_06-0_2-0_01-0_0-C

mkdir $output_folder/../0_06-0_05-0_01-0_0-C
cp $output_folder/checkpoint* $output_folder/../0_06-0_05-0_01-0_0-C
