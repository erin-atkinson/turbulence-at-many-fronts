...
#SBATCH --time=4:00:00
#SBATCH --job-name=outer-test-x1100
#SBATCH --output=../scratch/logs/outer-test-x1100.txt
...
output_folder=$SCRATCH/turbulence-at-many-fronts/outer-test-x1100
