...
#SBATCH --time=4:00:00
#SBATCH --job-name=size-test-h2
#SBATCH --output=../scratch/logs/size-test-h2.txt
...
output_folder=$SCRATCH/turbulence-at-many-fronts/size-test-h2
...
comment="Central region size test 2"
