...
#SBATCH --time=4:00:00
#SBATCH --job-name=size-test-h5
#SBATCH --output=../scratch/logs/size-test-h5.txt
...
output_folder=$SCRATCH/turbulence-at-many-fronts/size-test-h5
...
comment="Central region size test 5"
