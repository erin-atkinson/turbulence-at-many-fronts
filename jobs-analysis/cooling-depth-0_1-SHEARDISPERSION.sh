...
#SBATCH --time=1:30:00
#SBATCH --job-name=cooling-depth-0_1-SHEARDISPERSION
#SBATCH --output=../scratch/logs/cooling-depth-0_1-SHEARDISPERSION.txt
...
RAM=/dev/shm/cooling-depth-0_1-SHEARDISPERSION
mkdir $RAM
