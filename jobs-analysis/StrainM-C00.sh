...
#SBATCH --time=5:00:00
#SBATCH --job-name=ppStrainM-C00
#SBATCH --output=../scratch/logs/ppStrainM-C00.txt

module load julia/1.10.10

export RAM=/dev/shm/ppStrainM-C00
mkdir $RAM
...
export SIM_OUTPUT_FOLDER=../scratch/turbulence-at-many-fronts/StrainM-C00
