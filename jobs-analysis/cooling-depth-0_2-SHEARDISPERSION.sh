...
#SBATCH --time=1:30:00
#SBATCH --job-name=cooling-depth-0_2-SHEARDISPERSION
#SBATCH --output=../scratch/logs/cooling-depth-0_2-SHEARDISPERSION.txt
...
RAM=/dev/shm/cooling-depth-0_2-SHEARDISPERSION
mkdir $RAM
